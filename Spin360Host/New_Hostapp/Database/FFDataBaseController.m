...
#import "FFDataBaseController.h"

@interface FFDataBaseController ()
...
@implementation FFDataBaseController
...
+ (FFDataBaseController *)sharedInstance {
    ...
    static FFDataBaseController *sharedInstance;
    dispatch_once(&once, ^{
...
- (BOOL)saveContext {
    ...
    [_masterManagedObjectContext setMergePolicy:mergePolicy];
    if (![_masterManagedObjectContext save:&error]) {
        return false;
    }
...
- (NSManagedObjectContext *)masterManagedObjectContext {
    ...
    if (coordinator != nil) {
        ...
        [_masterManagedObjectContext performBlockAndWait:^{
            [self->_masterManagedObjectContext setPersistentStoreCoordinator:coordinator];
        }];
...
- (NSManagedObjectContext *)backgroundManagedObjectContext {
    ...
    if (masterContext != nil) {
        ...
        [_backgroundManagedObjectContext performBlockAndWait:^{
            [self->_backgroundManagedObjectContext setParentContext:masterContext];
        }];
    }
...
//    NSURL *modelURL = [[NSBundle bundleWithIdentifier:@"com.flickfusion.FFSpinSDK"] URLForResource:@"FFSpinDB" withExtension:@"momd"];
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"FFHostAppDB" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"FFHostAppDB.sqlite"];
...
- (NSURL *)applicationDocumentsDirectory {
    ...
    path = [path stringByAppendingPathComponent:@"FFHostAppDB"];
